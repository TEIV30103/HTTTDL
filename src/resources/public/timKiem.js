            ...
            location.forEach(location =>{
                ...
                google.maps.event.addListener(marker, 'click', function() {
                    var infowindow = new google.maps.InfoWindow({
                        content: '<div style="width:200px"> <div> <img src="/img/'+location.img+'" alt="Image" style="width:200px;height:auto;"> </div>        <div style=" margin-top: 10px"><strong><b>Tên Cửa Hàng: </b>'+location.tenCH+'</strong><br> <br><strong><b>Địa Chỉ:</b>'+location.diaChi+'</strong> <br> <br> <form method="post" action="/">    <input type="text" name="maCH" value="'+location.maCH+'" hidden /> <input type="text" name="hinhAnh" value="'+location.img+'" hidden />  <button class="buttonXoa" type="submit">Xoá</button>  <input type="button" id="buttonThongKe'+location.maCH+'" class="buttonThongKe"  value="Thống Kê" /> <input type="button" id="buttonSua'+location.maCH+'" class="buttonThongKe"  value="Sửa Thông Tin" /></form> </div> </div>'
