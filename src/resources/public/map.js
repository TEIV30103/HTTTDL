          ...
          let marker = new google.maps.Marker({
            ...
            google.maps.event.addListener(marker, 'click', function() {
              var infowindow = new google.maps.InfoWindow({
                content: '<div style="width:200px"> <div> <img src="/img/'+arrCH[i].img+'" alt="Image" style="width:200px;height:auto;"> </div>        <div style=" margin-top: 10px"><strong><b>Tên Cửa Hàng: </b>'+arrCH[i].tenCH+'</strong><br> <br><strong><b>Địa Chỉ:</b>'+arrCH[i].diaChi+'</strong> <br> <br> <form method="post" action="/">    <input type="text" name="maCH" value="'+arrCH[i].maCH+'" hidden /> <input type="text" name="hinhAnh" value="'+arrCH[i].img+'" hidden />  <button class="buttonXoa" type="submit">Xoá</button>  <input type="button" id="buttonThongKe'+arrCH[i].maCH+'" class="buttonThongKe"  value="Thống Kê" /> <input type="button" id="buttonSua'+arrCH[i].maCH+'" class="buttonThongKe"  value="Sửa Thông Tin" /></form> </div> </div>'
